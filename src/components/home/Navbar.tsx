        ...
        >
          <div className="flex items-center justify-between w-full max-w-7xl mx-auto">
                  ...
                  >
                    {isActive ? (
                      ...
                      <span className="block p-[1.5px] rounded-full bg-gradient-to-r from-[#FF0080] via-[#FF52A9] to-[#FF0080] bg-[length:200%_100%] animate-border-spin">
                        <span className="block px-5 py-0.5 rounded-full bg-[#010302]">
                          {link.name}
                        </span>
                      </span>
                    ) : (
                      <span className="block px-5 py-0.5">{link.name}</span>
                    )}
                  </Link>
                );
              })}
            ...
            <div className="hidden md:block">
              <Button
                size="sm"
                className="rounded-full bg-[#FF4AA5] hover:bg-pink-500 text-black font-semibold text-sm px-4 py-1 shadow-lg shadow-pink-500/25 transition-all hover:shadow-pink-500/40 select-none"
              >
                Get Early Access
              </Button>
            </div>
